<div class="col-lg-12 col-md-12 col-sm-12  col-xs-12" style=" padding: 0px;margin-bottom: 20px;  border-right:0;border-bottom:0"  id="Product_Ajax">
    ...
    <?php if($home_products): ?>
        <?php $__currentLoopData = $home_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
            ...
            ?>
    <div class="col-sm-4 col-md-2 col-xs-6  product-hover-area product-custom-area" style="padding: 5px;">
...
<span id="home_page_pagination">

           <?php echo $home_products->links(); ?>
...
<?php /**PATH C:\Xampp\htdocs\mylaravelecomerce\resources\views/website/home_page_ajax_category.blade.php ENDPATH**/ ?>