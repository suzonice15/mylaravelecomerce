...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="<?php echo e(asset('assets/adminfile')); ?>/bower_components/font-awesome/css/font-awesome.min.css">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/font_end/')); ?>/css/etalage.css" type="text/css"
          media="all"/>
    ...
    <link rel="shortcut icon" href="<?php echo e(url('/')); ?>/public/uploads/<?php echo e($get_single_option->icon); ?>"/>
            ...
            <div class="row" style="padding-top: 14px;">
                ...
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 padding-zero">
                    <div style="float: left">
                        <a href="<?php echo e(URL::to('/')); ?>"><img src="<?php echo e(url('/')); ?>/public/uploads/<?php echo e($get_single_option->logo); ?>"
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="top-menu-padding" style="padding-top: 20px;">
                            <a style="background:green;color:white;font-weight: bold;padding-left: 10px;padding-right: 10px;border-radius: 6px;"
                               href="tel:<?php echo e($get_single_option->phone); ?>" title="Call" class="font-color1">
                                <i class="fa fa-phone-square"> </i> <?php echo e($get_single_option->phone); ?>
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse" style="padding:0">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li class=" dropdown megaDropMenu color-2">
                    <a href="<?php echo e(url('/')); ?>/category/<?php echo e($first->category_name); ?>">
                                    <span style="font-weight: bold;">
                                      <?php echo e($first->category_title); ?>
    ...
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<?php echo e(URL::to('/')); ?>" style="float: left; padding-top: 10px;">
                ...
                <img src="<?php echo e(url('/')); ?>/public/uploads/<?php echo e($get_single_option->logo); ?>" class="img-responsive" alt="ajibto"
